...
from .routes import AuthRoutes, UserRoutes, LlamadosRoutes, CasosAprendizRoutes, CitacionesRoutes, ActasRoutes, ReportesRoutes
...
def init_app(config):
    ...
    app.register_blueprint(CitacionesRoutes.citacion, url_prefix='/citacion')
    app.register_blueprint(ActasRoutes.actas, url_prefix='/acta')
    app.register_blueprint(ReportesRoutes.reportes, url_prefix="/reportes")
